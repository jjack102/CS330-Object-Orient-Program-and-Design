...
class PolyhedronFactory {
    private:
        ...
        struct PolyhedronPair {
            ...
            PolyhedronPair(const PolyhedronPair& src) = delete;

            // Default Move Copy Constructor
            PolyhedronPair(PolyhedronPair&& src) = default;
            ...
            PolyhedronPair& operator=(const PolyhedronPair& rhs) = delete;

            // Default Assignment Operator
            PolyhedronPair& operator=(PolyhedronPair&& rhs) = default;
        };
